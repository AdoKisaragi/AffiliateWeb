...
(function () {
  ...
  if (footer) {
    footer.innerHTML = `<footer class="site-footer"><div class="container footer-grid">
      ...
      </div><div class="container associate-disclosure">${config.affiliateDisclosure} ${config.affiliateSupplement}</div><div class="container copyright">© 2026 CHOICE LAB. All Rights Reserved.</div></footer>`;
  }
